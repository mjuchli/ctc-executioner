...
\end{quote}
We study event data from a cryptocurrency exchange of our choice and build a framework that allows to simulate and understand the outcome of order placement in this market.
