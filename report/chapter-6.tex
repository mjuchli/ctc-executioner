...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{q_1_10000_BUY_mean_rewards.png}
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{q_1_10000_SELL_mean_rewards.png}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{q_2_10000_BUY_mean_rewards.png}
        \caption{Mean rewards per epoch (buy)}
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{q_2_10000_SELL_mean_rewards.png}
        \caption{Mean rewards per epoch (sell)}
...
The final evaluation will take place using the market making environment (described in Chapter \ref{chap:setup}) whereas we place buy and sell orders simultaneously and determine if the agent is capable of making a profit, which implies that on average the order placement must be better than the market price before the orders were placed.
Eventually, we conclude our findings and reason about the capabilities of the DQN approach (and its use of the market features) by comparing it to the previously stated Q-Learning results.
...
\subsection{Evaluation of limitations using artificial market data}

\subsection{Capability of making profits by acting as a market maker}
