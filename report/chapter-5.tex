...
Important to note is the criteria for reaching the final state; that is, when the entire inventory was bought or sold, $i=0$--Checkmate!.
...
Q-learning has proven to be an efficient and effective choice to solve problems in a discrete state space.
...
\hfill
\\
Algorithm \ref{alg:q-learning} describes the algorithm used in this work.
