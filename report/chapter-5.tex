...
The first and second hidden layers convolve filters with stride 4 and stride 2 with the input and applies a rectifier nonlinearity \cite{jarrett2009best}. 
...
%\\
%\\
%In order to have a means of comparisons regarding the state-of-the-art deep reinforcement learning architecture described above, we will also make use and briefly evaluate a second, much simpler method.
%A multi-layer artificial neural network with input 
%We refer to this architecture of neural networks trained with our approach as Deep Neural-Networks (DNN).